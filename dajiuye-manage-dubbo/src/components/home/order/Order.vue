<template>
  <div class="order">
    ...
    <!--    修改地址的对话框-->
    <el-dialog title="修改地址" v-model:visible="addressDialogVisible" @close="addressDialogClosed" width="50%">
    ...
    <!--    显示物流进度的对话框-->
    <el-dialog title="物流进度" v-model:visible="progressDialogVisible" width="50%">
