<template>
  <div class="params">
    ...
    <el-card>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        ...
        <el-tab-pane label="动态参数" name="many">
          <el-button type="primary" @click="addDialogVisible = true" size="small" :disabled="isBtnDisabled">添加参数</el-button>
          <!-- 动态参数表格 -->
          <el-table :data="manyTableData" stripe>
            ...
            <el-table-column label="操作">
              <template v-slot="scope">
                <el-button type="primary" @click="showEditDialog(scope.row.attr_id)" icon="el-icon-edit" size="small">编辑</el-button>
                <el-button type="danger" @click="removeParams(scope.row.attr_id)" icon="el-icon-delete" size="small">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-tab-pane>
        ...
        <el-tab-pane label="静态属性" name="only">
          <el-button type="primary" @click="addDialogVisible = true" size="small" :disabled="isBtnDisabled">添加属性</el-button>
          <!-- 静态参数表格 -->
    ...
    <!-- 添加参数的对话框 -->
    <el-dialog :title="'添加' + titleText" v-model:visible="addDialogVisible" width="50%" @close="addDialogClosed">
    ...
    <!-- 修改参数对话框 -->
    <el-dialog :title="'修改' + titleText" v-model:visible="editDialogVisible" width="50%" @close="editDialogClosed">
...
export default {
  ...
  methods: {
    // 获取所有商品分类的数据
    async getCateList () {
      const { data: res } = await axios.ajax({ url: 'categories' })
