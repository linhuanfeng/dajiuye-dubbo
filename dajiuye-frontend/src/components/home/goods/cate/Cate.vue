<template>
  <div class="cate">
    ...
    <!-- 添加分类的对话框   -->
    <el-dialog title="添加分类" v-model:visible="addCateDialogVisible" width="50%" @close="addCateDialogClosed">
    ...
    <!-- 编辑分类信息 -->
    <el-dialog title="修改分类" v-model:visible="editCateDialogVisbel" width="50%">
