...
import com.lhf.dajiuye.api.service.user.UpLoadImgService;
import com.lhf.dajiuye.user.service.config.CloudStorageConfig;
...
@DubboService(interfaceClass = UpLoadImgService.class,version = "1.0.0")
