...
import com.lhf.dajiuye.user.service.config.AliYunOssConfig;
import com.lhf.dajiuye.user.service.utils.FileNameUtil;
...
@DubboService(interfaceClass = OssFileService.class,version = "1.0.0")
